...
(function ($) {
    $.alert_ext = {
        ...
        // Balloon template
        tmpl: '<div class="alert alert-dismissable ${State}"><button type="button" class="close" data-dismiss="alert" aria-hidden="true" style="margin-top: -13px; margin-right: 6px; font-size: 15px;">&times;</button><div class="header1"><div class="icon">${Icon}</div><strong>${Title}</strong><p>${Content}</p></div></div>',
