var RumcaJS = function(s, a) {
    ...
    this.elem = $(a), this.selector = a.selector, this.options = s, this.init = function(s) {
        var a = '<div class="chart--top"><div class="chart__axis-y"></div><div class="chart__box chart--horizontal"> <div class="chart__bars"></div></div></div><div class="chart__axis-x"></div>';
